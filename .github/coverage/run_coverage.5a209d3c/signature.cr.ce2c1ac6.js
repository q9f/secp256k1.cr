...
{"lineNum":"   36","line":"  # ```"},
{"lineNum":"   37","line":"  def self.sign(msg : String, priv : BigInt)","class":"lineCov","hits":"2","order":"280","possible_hits":"2",},
{"lineNum":"   38","line":"    # Calculate the message hash, using the cryptographic hash function SHA-256."},
{"lineNum":"   39","line":"    hash = BigInt.new Hash.sha256(msg), 16","class":"lineCov","hits":"1","order":"281","possible_hits":"1",},
{"lineNum":"   40","line":""},
...
{"lineNum":"   43","line":"    k = Util.new_private_key","class":"lineCov","hits":"1","order":"282","possible_hits":"1",},
{"lineNum":"   44","line":""},
{"lineNum":"   45","line":"    # Calculate the random point `r = k * g` and take its `x`-coordinate: `r = r.x`."},
{"lineNum":"   46","line":"    r = Core.ec_mul(EC_BASE_G, k).x % EC_ORDER_N","class":"lineCov","hits":"1","order":"289","possible_hits":"1",},
{"lineNum":"   47","line":""},
{"lineNum":"   48","line":"    # Calculate the signature proof `s = k^-1 * (h + r * priv) % n`."},
{"lineNum":"   49","line":"    k_inv = Core.ec_mod_inv k, EC_ORDER_N","class":"lineCov","hits":"1","order":"290","possible_hits":"1",},
{"lineNum":"   50","line":"    s = ((hash + r * priv) * k_inv) % EC_ORDER_N","class":"lineCov","hits":"1","order":"291","possible_hits":"1",},
{"lineNum":"   51","line":""},
{"lineNum":"   52","line":"    # Return the signature."},
{"lineNum":"   53","line":"    ECDSASignature.new r, s","class":"lineCov","hits":"1","order":"292","possible_hits":"1",},
{"lineNum":"   54","line":"  end"},
{"lineNum":"   55","line":""},
...
{"lineNum":"   74","line":"  # ```"},
{"lineNum":"   75","line":"  def self.verify(msg : String, sig : ECDSASignature, pub : ECPoint)","class":"lineCov","hits":"2","order":"294","possible_hits":"2",},
{"lineNum":"   76","line":"    # Calculate the message hash, with the same hash function used during the signing."},
{"lineNum":"   77","line":"    hash = BigInt.new Hash.sha256(msg), 16","class":"lineCov","hits":"1","order":"295","possible_hits":"1",},
{"lineNum":"   78","line":"    verify_hash hash, sig, pub","class":"lineCov","hits":"1","order":"296","possible_hits":"1",},
{"lineNum":"   79","line":"  end"},
{"lineNum":"   80","line":""},
...
{"lineNum":"   91","line":"  def self.verify_hash(hash : BigInt, sig : ECDSASignature, pub : ECPoint)","class":"lineCov","hits":"2","order":"297","possible_hits":"2",},
{"lineNum":"   92","line":"    # Calculate the modular inverse of the signature proof: `s1 = s^{-1} % n`."},
{"lineNum":"   93","line":"    s_inv = Core.ec_mod_inv sig.s, EC_ORDER_N","class":"lineCov","hits":"1","order":"298","possible_hits":"1",},
{"lineNum":"   94","line":""},
{"lineNum":"   95","line":"    # Recover the random point used during the signing: `R\' = (h * s1) * g + (r * s1) * pub`"},
{"lineNum":"   96","line":"    p0 = Core.ec_mul EC_BASE_G, (hash * s_inv) % EC_ORDER_N","class":"lineCov","hits":"1","order":"299","possible_hits":"1",},
{"lineNum":"   97","line":"    p1 = Core.ec_mul pub, (sig.r * s_inv) % EC_ORDER_N","class":"lineCov","hits":"1","order":"300","possible_hits":"1",},
{"lineNum":"   98","line":"    p = Core.ec_add p0, p1","class":"lineCov","hits":"1","order":"301","possible_hits":"1",},
{"lineNum":"   99","line":""},
{"lineNum":"  100","line":"    # Calculate the signature validation result by comparing whether `r\' == r`."},
{"lineNum":"  101","line":"    sig.r === p.x","class":"lineCov","hits":"1","order":"302","possible_hits":"1",},
{"lineNum":"  102","line":"  end"},
{"lineNum":"  103","line":"end"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "run_coverage", "date" : "2021-12-13 12:03:11", "instrumented" : 16, "covered" : 16,};
var merged_data = [];
