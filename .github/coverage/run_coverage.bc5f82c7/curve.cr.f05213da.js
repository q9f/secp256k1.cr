...
{"lineNum":"   36","line":"  # ```"},
{"lineNum":"   37","line":"  def mod_inv(a : Num | BigInt, prime = P) : Num","class":"lineCov","hits":"8","order":"47","possible_hits":"8",},
{"lineNum":"   38","line":"    a = a.to_big if a.is_a? Num","class":"lineCov","hits":"1","order":"48","possible_hits":"1",},
{"lineNum":"   39","line":"    prime = prime.to_big if prime.is_a? Num","class":"lineCov","hits":"2","order":"49","possible_hits":"2",},
{"lineNum":"   40","line":"    m_low = 1","class":"lineCov","hits":"2","order":"50","possible_hits":"2",},
{"lineNum":"   41","line":"    m_high = 0","class":"lineCov","hits":"2","order":"51","possible_hits":"2",},
{"lineNum":"   42","line":"    v_low = a % prime","class":"lineCov","hits":"2","order":"52","possible_hits":"2",},
{"lineNum":"   43","line":"    v_high = prime","class":"lineCov","hits":"2","order":"53","possible_hits":"2",},
{"lineNum":"   44","line":"    while v_low > 1","class":"lineCov","hits":"2","order":"54","possible_hits":"2",},
{"lineNum":"   45","line":"      v_ratio = v_high // v_low","class":"lineCov","hits":"4","order":"55","possible_hits":"4",},
{"lineNum":"   46","line":"      m_low_r = m_low * v_ratio","class":"lineCov","hits":"4","order":"56","possible_hits":"4",},
{"lineNum":"   47","line":"      v_low_r = v_low * v_ratio","class":"lineCov","hits":"4","order":"57","possible_hits":"4",},
{"lineNum":"   48","line":"      m = m_high - m_low_r","class":"lineCov","hits":"4","order":"58","possible_hits":"4",},
{"lineNum":"   49","line":"      v = v_high - v_low_r","class":"lineCov","hits":"2","order":"59","possible_hits":"2",},
{"lineNum":"   50","line":"      m_high = m_low","class":"lineCov","hits":"2","order":"60","possible_hits":"2",},
{"lineNum":"   51","line":"      v_high = v_low","class":"lineCov","hits":"2","order":"61","possible_hits":"2",},
{"lineNum":"   52","line":"      m_low = m","class":"lineCov","hits":"2","order":"62","possible_hits":"2",},
{"lineNum":"   53","line":"      v_low = v","class":"lineCov","hits":"6","order":"63","possible_hits":"6",},
{"lineNum":"   54","line":"    end"},
{"lineNum":"   55","line":"    Num.new m_low % prime","class":"lineCov","hits":"2","order":"64","possible_hits":"2",},
{"lineNum":"   56","line":"  end"},
{"lineNum":"   57","line":""},
...
{"lineNum":"   81","line":"  # ```"},
{"lineNum":"   82","line":"  def add(p : Point, q : Point, prime = P) : Point","class":"lineCov","hits":"4","order":"72","possible_hits":"4",},
{"lineNum":"   83","line":"    prime = prime.to_big if prime.is_a? Num","class":"lineCov","hits":"1","order":"73","possible_hits":"1",},
{"lineNum":"   84","line":"    p_x = p.x.to_big","class":"lineCov","hits":"1","order":"74","possible_hits":"1",},
{"lineNum":"   85","line":"    p_y = p.y.to_big","class":"lineCov","hits":"1","order":"75","possible_hits":"1",},
{"lineNum":"   86","line":"    q_x = q.x.to_big","class":"lineCov","hits":"1","order":"76","possible_hits":"1",},
{"lineNum":"   87","line":"    q_y = q.y.to_big","class":"lineCov","hits":"1","order":"77","possible_hits":"1",},
{"lineNum":"   88","line":"    x_delta = q_x - p_x","class":"lineCov","hits":"1","order":"78","possible_hits":"1",},
{"lineNum":"   89","line":"    x_inv = mod_inv x_delta","class":"lineCov","hits":"1","order":"79","possible_hits":"1",},
{"lineNum":"   90","line":"    y_delta = q_y - p_y","class":"lineCov","hits":"1","order":"80","possible_hits":"1",},
{"lineNum":"   91","line":"    m = (y_delta * x_inv.to_big) % prime","class":"lineCov","hits":"1","order":"81","possible_hits":"1",},
{"lineNum":"   92","line":"    x = (m * m - p_x - q_x) % prime","class":"lineCov","hits":"1","order":"82","possible_hits":"1",},
{"lineNum":"   93","line":"    y = (m * (p_x - x) - p_y) % prime","class":"lineCov","hits":"1","order":"83","possible_hits":"1",},
{"lineNum":"   94","line":"    x = Num.new x","class":"lineCov","hits":"1","order":"84","possible_hits":"1",},
{"lineNum":"   95","line":"    y = Num.new y","class":"lineCov","hits":"1","order":"85","possible_hits":"1",},
{"lineNum":"   96","line":"    Point.new x, y","class":"lineCov","hits":"1","order":"86","possible_hits":"1",},
{"lineNum":"   97","line":"  end"},
{"lineNum":"   98","line":""},
...
{"lineNum":"  122","line":"  # ```"},
{"lineNum":"  123","line":"  def double(p : Point, prime = P) : Point","class":"lineCov","hits":"4","order":"34","possible_hits":"4",},
{"lineNum":"  124","line":"    prime = prime.to_big if prime.is_a? Num","class":"lineCov","hits":"1","order":"35","possible_hits":"1",},
{"lineNum":"  125","line":"    p_x = p.x.to_big","class":"lineCov","hits":"1","order":"36","possible_hits":"1",},
{"lineNum":"  126","line":"    p_y = p.y.to_big","class":"lineCov","hits":"1","order":"37","possible_hits":"1",},
{"lineNum":"  127","line":"    lam_numer = 3 * p_x * p_x","class":"lineCov","hits":"1","order":"38","possible_hits":"1",},
{"lineNum":"  128","line":"    lam_denom = 2 * p_y","class":"lineCov","hits":"1","order":"39","possible_hits":"1",},
{"lineNum":"  129","line":"    lam_inv = mod_inv Num.new lam_denom","class":"lineCov","hits":"1","order":"40","possible_hits":"1",},
{"lineNum":"  130","line":"    lam = (lam_numer * lam_inv.to_big) % prime","class":"lineCov","hits":"1","order":"65","possible_hits":"1",},
{"lineNum":"  131","line":"    x = (lam * lam - 2 * p_x) % prime","class":"lineCov","hits":"1","order":"66","possible_hits":"1",},
{"lineNum":"  132","line":"    y = (lam * (p_x - x) - p_y) % prime","class":"lineCov","hits":"1","order":"67","possible_hits":"1",},
{"lineNum":"  133","line":"    x = Num.new x","class":"lineCov","hits":"1","order":"68","possible_hits":"1",},
{"lineNum":"  134","line":"    y = Num.new y","class":"lineCov","hits":"1","order":"69","possible_hits":"1",},
{"lineNum":"  135","line":"    Point.new x, y","class":"lineCov","hits":"1","order":"70","possible_hits":"1",},
...
{"lineNum":"  170","line":"      next if index === 0","class":"linePartCov","hits":"2","order":"31","possible_hits":"6",},
{"lineNum":"  171","line":"      q = double q","class":"linePartCov","hits":"2","order":"33","possible_hits":"4",},
{"lineNum":"  172","line":"      if char === \'1\'","class":"linePartCov","hits":"4","order":"71","possible_hits":"8",},
{"lineNum":"  173","line":"        q = add q, p","class":"linePartCov","hits":"4","order":"32","possible_hits":"8",},
