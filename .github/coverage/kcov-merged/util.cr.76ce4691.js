...
{"lineNum":"   31","line":"  # # => \"07\""},
{"lineNum":"   32","line":"  # ```"},
{"lineNum":"   33","line":"  def self.to_padded_hex_01(i : Int32)","class":"lineCov","hits":"1","order":"121",},
{"lineNum":"   34","line":"    hex = i.to_s 16","class":"lineCov","hits":"1","order":"122",},
{"lineNum":"   35","line":"    while hex.size < 2","class":"lineCov","hits":"1","order":"123",},
{"lineNum":"   36","line":"      hex = \'0\' + hex","class":"lineCov","hits":"1","order":"231",},
{"lineNum":"   37","line":"    end"},
{"lineNum":"   38","line":"    hex"},
{"lineNum":"   39","line":"  end"},
{"lineNum":"   40","line":""},
...
{"lineNum":"   50","line":"  # ```"},
{"lineNum":"   51","line":"  def self.to_padded_hex_32(i : BigInt)","class":"lineCov","hits":"1","order":"14",},
{"lineNum":"   52","line":"    hex = i.to_s 16","class":"lineCov","hits":"1","order":"15",},
{"lineNum":"   53","line":"    while hex.size < 64","class":"lineCov","hits":"1","order":"16",},
{"lineNum":"   54","line":"      hex = \'0\' + hex","class":"lineCov","hits":"1","order":"176",},
{"lineNum":"   55","line":"    end"},
{"lineNum":"   56","line":"    hex"},
{"lineNum":"   57","line":"  end"},
{"lineNum":"   58","line":""},
...
{"lineNum":"   65","line":"  # ```"},
{"lineNum":"   66","line":"  def self.new_private_key","class":"lineCov","hits":"1","order":"284",},
{"lineNum":"   67","line":"    key = -999","class":"lineCov","hits":"1","order":"285",},
{"lineNum":"   68","line":"    until key > 0","class":"lineCov","hits":"1","order":"286",},
{"lineNum":"   69","line":"      key = Random::Secure.hex 32","class":"lineCov","hits":"1","order":"287",},
{"lineNum":"   70","line":"      key = BigInt.new key, 16","class":"lineCov","hits":"1","order":"288",},
{"lineNum":"   71","line":"    end"},
{"lineNum":"   72","line":"    key % EC_ORDER_N","class":"lineCov","hits":"1","order":"289",},
{"lineNum":"   73","line":"  end"},
{"lineNum":"   74","line":""},
...
{"lineNum":"   90","line":"  # ```"},
{"lineNum":"   91","line":"  private def self.public_key_compressed(p : ECPoint)","class":"lineCov","hits":"1","order":"12",},
{"lineNum":"   92","line":"    to_padded_hex_32 p.x","class":"lineCov","hits":"1","order":"13",},
{"lineNum":"   93","line":"  end"},
{"lineNum":"   94","line":""},
...
{"lineNum":"  108","line":"  # ```"},
{"lineNum":"  109","line":"  def self.public_key_compressed_prefix(p : ECPoint)","class":"lineCov","hits":"1","order":"9",},
{"lineNum":"  110","line":"    prefix = p.y % 2 === 1 ? \"03\" : \"02\"","class":"lineCov","hits":"1","order":"10",},
{"lineNum":"  111","line":"    \"#{prefix}#{public_key_compressed p}\"","class":"lineCov","hits":"1","order":"11",},
...
{"lineNum":"  125","line":"  # ```"},
{"lineNum":"  126","line":"  def self.public_key_uncompressed(p : ECPoint)","class":"lineCov","hits":"1","order":"20",},
{"lineNum":"  127","line":"    x = to_padded_hex_32 p.x","class":"lineCov","hits":"1","order":"21",},
{"lineNum":"  128","line":"    y = to_padded_hex_32 p.y","class":"lineCov","hits":"1","order":"22",},
{"lineNum":"  129","line":"    \"#{x}#{y}\"","class":"lineCov","hits":"1","order":"23",},
...
{"lineNum":"  143","line":"  # ```"},
{"lineNum":"  144","line":"  def self.public_key_uncompressed_prefix(p : ECPoint)","class":"lineCov","hits":"1","order":"18",},
{"lineNum":"  145","line":"    \"04#{public_key_uncompressed p}\"","class":"lineCov","hits":"1","order":"19",},
...
{"lineNum":"  163","line":"  def self.decode_compressed_public_key(pub : String, prime = EC_PRIME_P)","class":"lineCov","hits":"1","order":"318",},
{"lineNum":"  164","line":"    # Only proceed if we have one prefix byte and 32 coordinate bytes."},
{"lineNum":"  165","line":"    if pub.size === 66","class":"lineCov","hits":"1","order":"319",},
{"lineNum":"  166","line":"      # The prefix is used to restore the `y`-coordinate."},
{"lineNum":"  167","line":"      prefix = pub[0, 2]","class":"lineCov","hits":"1","order":"320",},
{"lineNum":"  168","line":"      if prefix === \"02\" || prefix === \"03\"","class":"lineCov","hits":"1","order":"321",},
{"lineNum":"  169","line":"        # `x` is simply the coordinate."},
{"lineNum":"  170","line":"        x = BigInt.new pub[2, 64], 16","class":"lineCov","hits":"1","order":"322",},
{"lineNum":"  171","line":""},
{"lineNum":"  172","line":"        # `y` is on our curve `(x^3 + 7) ^ ((p + 1) / 4) % p`"},
{"lineNum":"  173","line":"        a = x ** 3 % prime","class":"lineCov","hits":"1","order":"323",},
{"lineNum":"  174","line":"        a = (a + 7) % prime","class":"lineCov","hits":"1","order":"324",},
{"lineNum":"  175","line":"        e = ((prime + 1) // 4) % prime","class":"lineCov","hits":"1","order":"325",},
{"lineNum":"  176","line":"        y = BigInt.new","class":"lineCov","hits":"1","order":"326",},
{"lineNum":"  177","line":"        LibGMP.mpz_powm_sec(y, a, e, prime)","class":"lineCov","hits":"1","order":"327",},
{"lineNum":"  178","line":""},
{"lineNum":"  179","line":"        # Check which of the two possible `y` values is to be used."},
{"lineNum":"  180","line":"        parity = prefix.to_i - 2","class":"lineCov","hits":"1","order":"328",},
{"lineNum":"  181","line":"        if y % 2 != parity","class":"lineCov","hits":"1","order":"329",},
{"lineNum":"  182","line":"          y = -y % prime","class":"lineNoCov","hits":"0",},
{"lineNum":"  183","line":"        end"},
{"lineNum":"  184","line":"        ECPoint.new x, y","class":"lineCov","hits":"1","order":"330",},
{"lineNum":"  185","line":"      else"},
{"lineNum":"  186","line":"        raise \"invalid prefix for compressed public key: #{prefix}\"","class":"lineCov","hits":"1","order":"332",},
{"lineNum":"  187","line":"      end"},
{"lineNum":"  188","line":"    else"},
{"lineNum":"  189","line":"      raise \"malformed compressed public key (invalid key size: #{pub.size})\"","class":"lineCov","hits":"1","order":"331",},
...
{"lineNum":"  207","line":"  private def self.decode_uncompressed_public_key(pub : String)","class":"lineCov","hits":"1","order":"309",},
{"lineNum":"  208","line":"    # Remove the prefix as it\'s always `\"04\"` for uncompressed keys."},
{"lineNum":"  209","line":"    pub = pub[2, 128] if pub.size === 130","class":"lineCov","hits":"1","order":"310",},
{"lineNum":"  210","line":""},
{"lineNum":"  211","line":"    # Only proceed if we have two times 32 bytes (`x`, `y`)."},
{"lineNum":"  212","line":"    if pub.size === 128","class":"lineCov","hits":"1","order":"311",},
{"lineNum":"  213","line":"      x = BigInt.new pub[0, 64], 16","class":"lineCov","hits":"1","order":"312",},
{"lineNum":"  214","line":"      y = BigInt.new pub[64, 64], 16","class":"lineCov","hits":"1","order":"313",},
{"lineNum":"  215","line":"      ECPoint.new x, y","class":"lineCov","hits":"1","order":"314",},
{"lineNum":"  216","line":"    else"},
{"lineNum":"  217","line":"      raise \"malformed uncompressed public key (invalid key size: #{pub.size})\"","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  234","line":"  def self.restore_public_key(pub : String, prime = EC_PRIME_P)","class":"lineCov","hits":"1","order":"305",},
{"lineNum":"  235","line":"    case pub.size","class":"lineCov","hits":"1","order":"306",},
{"lineNum":"  236","line":"    when 130, 128","class":"lineCov","hits":"1","order":"307",},
{"lineNum":"  237","line":"      decode_uncompressed_public_key pub","class":"lineCov","hits":"1","order":"308",},
{"lineNum":"  238","line":"    when 66","class":"lineCov","hits":"1","order":"316",},
{"lineNum":"  239","line":"      decode_compressed_public_key pub, prime","class":"lineCov","hits":"1","order":"317",},
{"lineNum":"  240","line":"    else"},
{"lineNum":"  241","line":"      raise \"unknown public key format (invalid key size: #{pub.size})\"","class":"lineCov","hits":"1","order":"315",},
...
{"lineNum":"  258","line":"  def self.public_key_from_private(priv : BigInt)","class":"lineCov","hits":"1","order":"29",},
{"lineNum":"  259","line":"    Core.ec_mul EC_BASE_G, priv","class":"lineCov","hits":"1","order":"30",},
{"lineNum":"  260","line":"  end"},
{"lineNum":"  261","line":"end"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "run_coverage", "date" : "2021-09-29 14:18:30", "instrumented" : 57, "covered" : 55,};
var merged_data = [];
