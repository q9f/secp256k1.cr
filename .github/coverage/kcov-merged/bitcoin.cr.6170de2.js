...
{"lineNum":"   74","line":"    def initialize(@key_pair)","class":"lineCov","hits":"1","order":"171",},
{"lineNum":"   75","line":"      @version = \"00\"","class":"lineCov","hits":"1","order":"172",},
{"lineNum":"   76","line":"      @compressed = false","class":"lineCov","hits":"1","order":"173",},
{"lineNum":"   77","line":"      @address = Bitcoin.address_from_private @key_pair.private_key, @version, @compressed","class":"lineCov","hits":"1","order":"174",},
{"lineNum":"   78","line":"      @wif = Bitcoin.wif_from_private_uncompressed @key_pair.private_key, version_wif","class":"lineCov","hits":"1","order":"175",},
{"lineNum":"   79","line":"    end"},
{"lineNum":"   80","line":""},
...
{"lineNum":"   97","line":"    def initialize(@key_pair, @version)","class":"lineCov","hits":"1","order":"134",},
{"lineNum":"   98","line":"      v = @version.to_i 16","class":"lineCov","hits":"1","order":"135",},
{"lineNum":"   99","line":""},
{"lineNum":"  100","line":"      # Ensures a valid public key version byte (not WIF version byte)."},
{"lineNum":"  101","line":"      if !v.nil? && v >= 0 && v < 128","class":"lineCov","hits":"1","order":"136",},
{"lineNum":"  102","line":"        @compressed = false","class":"lineCov","hits":"1","order":"137",},
{"lineNum":"  103","line":"        @address = Bitcoin.address_from_private @key_pair.private_key, @version, @compressed","class":"lineCov","hits":"1","order":"138",},
{"lineNum":"  104","line":"        @wif = Bitcoin.wif_from_private_uncompressed @key_pair.private_key, version_wif","class":"lineCov","hits":"1","order":"139",},
{"lineNum":"  105","line":"      else"},
{"lineNum":"  106","line":"        raise \"invalid version byte provided (out of range: #{@version})\"","class":"lineCov","hits":"1","order":"142",},
...
{"lineNum":"  125","line":"    def initialize(@key_pair, @version, @compressed)","class":"lineCov","hits":"1","order":"75",},
{"lineNum":"  126","line":"      v = @version.to_i 16","class":"lineCov","hits":"1","order":"76",},
{"lineNum":"  127","line":""},
{"lineNum":"  128","line":"      # Ensures a valid public key version byte (not WIF version byte)."},
{"lineNum":"  129","line":"      if !v.nil? && v >= 0 && v < 128","class":"lineCov","hits":"1","order":"77",},
{"lineNum":"  130","line":"        @address = Bitcoin.address_from_private @key_pair.private_key, @version, @compressed","class":"lineCov","hits":"1","order":"78",},
{"lineNum":"  131","line":""},
{"lineNum":"  132","line":"        # Checks whether we want a compressed or uncompressed account."},
{"lineNum":"  133","line":"        if compressed","class":"lineCov","hits":"1","order":"117",},
{"lineNum":"  134","line":"          @wif = Bitcoin.wif_from_private_compressed @key_pair.private_key, version_wif","class":"lineCov","hits":"1","order":"118",},
{"lineNum":"  135","line":"        else"},
{"lineNum":"  136","line":"          @wif = Bitcoin.wif_from_private_uncompressed @key_pair.private_key, version_wif","class":"lineNoCov","hits":"0",},
{"lineNum":"  137","line":"        end"},
{"lineNum":"  138","line":"      else"},
{"lineNum":"  139","line":"        raise \"invalid version byte provided (out of range: #{@version})\"","class":"lineCov","hits":"1","order":"133",},
...
{"lineNum":"  160","line":"    # # => \"80\""},
{"lineNum":"  161","line":"    # ```"},
{"lineNum":"  162","line":"    def version_wif","class":"lineCov","hits":"1","order":"119",},
{"lineNum":"  163","line":"      Util.to_padded_hex_01(@version.to_i(16) + 128)","class":"lineCov","hits":"1","order":"120",},
...
{"lineNum":"  192","line":"  # ```"},
{"lineNum":"  193","line":"  def self.new_mini_private_key","class":"lineCov","hits":"1","order":"143",},
{"lineNum":"  194","line":"    valid = false","class":"lineCov","hits":"1","order":"144",},
{"lineNum":"  195","line":"    key = String.new","class":"lineCov","hits":"1","order":"145",},
{"lineNum":"  196","line":"    until valid","class":"lineCov","hits":"1","order":"146",},
{"lineNum":"  197","line":"      i = 1","class":"lineCov","hits":"1","order":"147",},
{"lineNum":"  198","line":""},
{"lineNum":"  199","line":"      # Mini-private keys always start with a capital `S`."},
{"lineNum":"  200","line":"      key = \"S\"","class":"lineCov","hits":"1","order":"148",},
{"lineNum":"  201","line":""},
{"lineNum":"  202","line":"      # Add 29 random characters from the Base-56 alphabet."},
{"lineNum":"  203","line":"      while i < 30","class":"lineCov","hits":"1","order":"149",},
{"lineNum":"  204","line":"        i += 1","class":"lineNoCov","hits":"0",},
{"lineNum":"  205","line":"        r = Random.rand 56","class":"lineCov","hits":"1","order":"150",},
{"lineNum":"  206","line":"        key += Hash.base56_char r","class":"lineCov","hits":"1","order":"151",},
{"lineNum":"  207","line":"      end"},
{"lineNum":"  208","line":""},
{"lineNum":"  209","line":"      # Makes sure the key\'s checksum passes."},
{"lineNum":"  210","line":"      valid = mini_is_valid? key","class":"lineCov","hits":"1","order":"155",},
{"lineNum":"  211","line":"      if valid","class":"lineCov","hits":"1","order":"163",},
{"lineNum":"  212","line":"        # It\'s only valid if the private key is within the `Secp256k1` field size `n`."},
{"lineNum":"  213","line":"        priv = private_key_from_mini key","class":"lineCov","hits":"1","order":"165",},
{"lineNum":"  214","line":"        valid = valid && priv > 0","class":"lineCov","hits":"1","order":"170",},
{"lineNum":"  215","line":"        valid = valid && priv === priv % Secp256k1::EC_ORDER_N","class":"lineCov","hits":"1","order":"164",},
...
{"lineNum":"  232","line":"  def self.private_key_from_mini(m : String)","class":"lineCov","hits":"1","order":"166",},
{"lineNum":"  233","line":"    if mini_is_valid? m","class":"lineCov","hits":"1","order":"167",},
{"lineNum":"  234","line":"      # The private key is just the SHA-256 hash."},
{"lineNum":"  235","line":"      private_key = Hash.sha256 m","class":"lineCov","hits":"1","order":"168",},
{"lineNum":"  236","line":"      BigInt.new private_key, 16","class":"lineCov","hits":"1","order":"169",},
{"lineNum":"  237","line":"    else"},
{"lineNum":"  238","line":"      raise \"mini private key is not valid (invalid checksum for: #{m})\"","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  253","line":"  def self.mini_is_valid?(m : String)","class":"lineCov","hits":"1","order":"156",},
{"lineNum":"  254","line":"    # It\'s only valid if it\'s 30 characters long and starts with a capital `S`."},
{"lineNum":"  255","line":"    valid = m.size === 30","class":"lineCov","hits":"1","order":"157",},
{"lineNum":"  256","line":"    valid = valid && m[0, 1] === \"S\"","class":"lineCov","hits":"1","order":"158",},
{"lineNum":"  257","line":""},
{"lineNum":"  258","line":"    # It\'s only a valid mini-private key if the hash of `#{key}?` starts with `\"00\"`."},
{"lineNum":"  259","line":"    checksum = Hash.sha256 \"#{m}?\"","class":"lineCov","hits":"1","order":"159",},
{"lineNum":"  260","line":"    valid && checksum[0, 2] === \"00\"","class":"lineCov","hits":"1","order":"162",},
...
{"lineNum":"  277","line":"  def self.wif_from_private(k : BigInt, version = \"80\", compr = \"\")","class":"lineCov","hits":"1","order":"126",},
{"lineNum":"  278","line":"    # Takes the private key."},
{"lineNum":"  279","line":"    priv = Secp256k1::Util.to_padded_hex_32 k","class":"lineCov","hits":"1","order":"127",},
{"lineNum":"  280","line":""},
{"lineNum":"  281","line":"    # Prepends the version byte and append the compression byte."},
{"lineNum":"  282","line":"    versioned = \"#{version}#{priv}#{compr}\"","class":"lineCov","hits":"1","order":"128",},
{"lineNum":"  283","line":""},
{"lineNum":"  284","line":"    # Performs a SHA-256 hash on the extended key."},
{"lineNum":"  285","line":"    hashed = Hash.sha256 Hash.hex_to_bin versioned","class":"lineCov","hits":"1","order":"129",},
{"lineNum":"  286","line":""},
{"lineNum":"  287","line":"    # Performs a SHA-256 hash on the result of the SHA-256 hash."},
{"lineNum":"  288","line":"    hashed_twice = Hash.sha256 Hash.hex_to_bin hashed","class":"lineCov","hits":"1","order":"130",},
{"lineNum":"  289","line":""},
...
{"lineNum":"  293","line":"    binary = \"#{versioned}#{hashed_twice[0, 8]}\"","class":"lineCov","hits":"1","order":"131",},
{"lineNum":"  294","line":""},
...
{"lineNum":"  297","line":"    Hash.base58_encode binary","class":"lineCov","hits":"1","order":"132",},
...
{"lineNum":"  309","line":"  # ```"},
{"lineNum":"  310","line":"  def self.wif_from_private_compressed(k : BigInt, version = \"80\")","class":"lineCov","hits":"1","order":"124",},
{"lineNum":"  311","line":"    # To indicate a compressed key to be used, append a `\"01\"` byte."},
{"lineNum":"  312","line":"    wif_from_private k, version, \"01\"","class":"lineCov","hits":"1","order":"125",},
...
{"lineNum":"  324","line":"  # ```"},
{"lineNum":"  325","line":"  def self.wif_from_private_uncompressed(k : BigInt, version = \"80\")","class":"lineCov","hits":"1","order":"140",},
{"lineNum":"  326","line":"    # To indicate an uncompressed key to be used, don\'t append a compression byte."},
{"lineNum":"  327","line":"    wif_from_private k, version, \"\"","class":"lineCov","hits":"1","order":"141",},
...
{"lineNum":"  341","line":"  def self.private_key_from_wif(wif : String)","class":"lineCov","hits":"1","order":"177",},
{"lineNum":"  342","line":"    # Decodes Base-58 which contains the checksummed private key."},
{"lineNum":"  343","line":"    checksum_key = Hash.base58_decode wif","class":"lineCov","hits":"1","order":"178",},
{"lineNum":"  344","line":""},
{"lineNum":"  345","line":"    # The key must be 37 bytes (uncompressed) or 38 bytes (compressed)."},
{"lineNum":"  346","line":"    if checksum_key.size == 74 || checksum_key.size == 76","class":"lineCov","hits":"1","order":"192",},
{"lineNum":"  347","line":"      # Drops the version byte, checksum, and compressed byte."},
{"lineNum":"  348","line":"      private_key = BigInt.new checksum_key[2, 64], 16","class":"lineCov","hits":"1","order":"193",},
{"lineNum":"  349","line":"      Secp256k1::Util.to_padded_hex_32 private_key","class":"lineCov","hits":"1","order":"194",},
{"lineNum":"  350","line":"    else"},
{"lineNum":"  351","line":"      raise \"invalid wallet import format (invalid wif size: #{checksum_key.size})\"","class":"lineCov","hits":"1","order":"195",},
...
{"lineNum":"  366","line":"  def self.version_byte_from_wif(wif : String)","class":"lineCov","hits":"1","order":"214",},
{"lineNum":"  367","line":"    # Decodes Base-58 which contains the checksummed private key."},
{"lineNum":"  368","line":"    versioned = Hash.base58_decode wif","class":"lineCov","hits":"1","order":"215",},
{"lineNum":"  369","line":""},
{"lineNum":"  370","line":"    # The key must be 37 bytes (uncompressed) or 38 bytes (compressed)."},
{"lineNum":"  371","line":"    if versioned.size === 74 || versioned.size === 76","class":"lineCov","hits":"1","order":"216",},
{"lineNum":"  372","line":"      # Extracts the version byte."},
{"lineNum":"  373","line":"      versioned[0, 2]","class":"lineCov","hits":"1","order":"217",},
{"lineNum":"  374","line":"    else"},
{"lineNum":"  375","line":"      raise \"invalid wallet import format (invalid wif size: #{versioned.size})\"","class":"lineCov","hits":"1","order":"218",},
...
{"lineNum":"  392","line":"  def self.is_wif_compressed?(wif : String)","class":"lineCov","hits":"1","order":"224",},
{"lineNum":"  393","line":"    # Decodes Base-58 which contains the checksummed private key."},
{"lineNum":"  394","line":"    versioned = Hash.base58_decode wif","class":"lineCov","hits":"1","order":"225",},
{"lineNum":"  395","line":""},
{"lineNum":"  396","line":"    # The key must be 37 bytes (uncompressed) or 38 bytes (compressed)."},
{"lineNum":"  397","line":"    if versioned.size === 74 || versioned.size === 76","class":"lineCov","hits":"1","order":"226",},
{"lineNum":"  398","line":"      # Returns _true_ if the key is compressed."},
{"lineNum":"  399","line":"      versioned.size === 76","class":"lineCov","hits":"1","order":"227",},
{"lineNum":"  400","line":"    else"},
{"lineNum":"  401","line":"      raise \"invalid wallet import format (invalid wif size: #{versioned.size})\"","class":"lineCov","hits":"1","order":"228",},
...
{"lineNum":"  416","line":"  def self.wif_is_valid?(wif : String)","class":"lineCov","hits":"1","order":"196",},
{"lineNum":"  417","line":"    # Decodes Base-58 which contains the checksummed private key."},
{"lineNum":"  418","line":"    checksum_key = Hash.base58_decode wif","class":"lineCov","hits":"1","order":"197",},
{"lineNum":"  419","line":""},
{"lineNum":"  420","line":"    # The key must be 37 bytes (uncompressed) or 38 bytes (compressed)."},
{"lineNum":"  421","line":"    valid = checksum_key.size === 74 || checksum_key.size === 76","class":"lineCov","hits":"1","order":"198",},
{"lineNum":"  422","line":""},
{"lineNum":"  423","line":"    # Only proceeds if the key is valid."},
{"lineNum":"  424","line":"    if valid","class":"lineCov","hits":"1","order":"199",},
{"lineNum":"  425","line":"      # Ensures the private key is valid."},
{"lineNum":"  426","line":"      private_key = private_key_from_wif wif","class":"lineCov","hits":"1","order":"200",},
{"lineNum":"  427","line":"      valid = valid && private_key != \"-999\" && private_key.size === 64","class":"lineCov","hits":"1","order":"201",},
{"lineNum":"  428","line":""},
{"lineNum":"  429","line":"      # Drops the checksum bytes."},
{"lineNum":"  430","line":"      versioned = checksum_key[0, 66]","class":"lineCov","hits":"1","order":"202",},
{"lineNum":"  431","line":"      wif_checksum = checksum_key[66, 8]","class":"lineCov","hits":"1","order":"203",},
{"lineNum":"  432","line":""},
{"lineNum":"  433","line":"      # Makes sure to honor the compression byte."},
{"lineNum":"  434","line":"      if checksum_key.size === 76","class":"lineCov","hits":"1","order":"204",},
{"lineNum":"  435","line":"        versioned = checksum_key[0, 68]","class":"lineCov","hits":"1","order":"209",},
{"lineNum":"  436","line":"        wif_checksum = checksum_key[68, 8]","class":"lineCov","hits":"1","order":"210",},
{"lineNum":"  437","line":"      end"},
{"lineNum":"  438","line":""},
{"lineNum":"  439","line":"      # Performs a SHA-256 hash on the versioned key."},
{"lineNum":"  440","line":"      hashed = Hash.sha256 Hash.hex_to_bin versioned","class":"lineCov","hits":"1","order":"205",},
{"lineNum":"  441","line":""},
{"lineNum":"  442","line":"      # Performs a SHA-256 hash on the result of the previous SHA-256 hash."},
{"lineNum":"  443","line":"      hashed_twice = Hash.sha256 Hash.hex_to_bin hashed","class":"lineCov","hits":"1","order":"206",},
{"lineNum":"  444","line":""},
{"lineNum":"  445","line":"      # Checks the WIF checksum against the private key checksum."},
{"lineNum":"  446","line":"      pk_checksum = hashed_twice[0, 8]","class":"lineCov","hits":"1","order":"207",},
{"lineNum":"  447","line":"      valid = valid && wif_checksum === pk_checksum","class":"lineCov","hits":"1","order":"208",},
...
{"lineNum":"  467","line":"  def self.address_from_public_key(pub : String, version = \"00\")","class":"lineCov","hits":"1","order":"86",},
{"lineNum":"  468","line":"    # Ensures uncompressed or compressed public keys with prefix."},
{"lineNum":"  469","line":"    if pub.size === 130 || pub.size === 66","class":"lineCov","hits":"1","order":"87",},
{"lineNum":"  470","line":"      # Performs a SHA-256 hash on the public key."},
{"lineNum":"  471","line":"      sha2 = Hash.sha256 Hash.hex_to_bin pub","class":"lineCov","hits":"1","order":"88",},
{"lineNum":"  472","line":""},
{"lineNum":"  473","line":"      # Performs a RIPEMD-160 hash on the result of the SHA-256 hash."},
{"lineNum":"  474","line":"      ripe = Hash.ripemd160 Hash.hex_to_bin sha2","class":"lineCov","hits":"1","order":"93",},
{"lineNum":"  475","line":""},
{"lineNum":"  476","line":"      # Adds a version byte in front of the RIPEMD-160 hash."},
{"lineNum":"  477","line":"      ripe_versioned = \"#{version}#{ripe}\"","class":"lineCov","hits":"1","order":"96",},
{"lineNum":"  478","line":""},
{"lineNum":"  479","line":"      # Performs a SHA-256 hash on the extended RIPEMD-160 result."},
{"lineNum":"  480","line":"      hashed = Hash.sha256 Hash.hex_to_bin ripe_versioned","class":"lineCov","hits":"1","order":"97",},
{"lineNum":"  481","line":""},
{"lineNum":"  482","line":"      # Performs a SHA-256 hash on the result of the previous SHA-256 hash."},
{"lineNum":"  483","line":"      hashed_twice = Hash.sha256 Hash.hex_to_bin hashed","class":"lineCov","hits":"1","order":"98",},
{"lineNum":"  484","line":""},
...
{"lineNum":"  488","line":"      binary = \"#{ripe_versioned}#{hashed_twice[0, 8]}\"","class":"lineCov","hits":"1","order":"99",},
{"lineNum":"  489","line":""},
...
{"lineNum":"  492","line":"      Hash.base58_encode binary","class":"lineCov","hits":"1","order":"100",},
{"lineNum":"  493","line":"    else"},
{"lineNum":"  494","line":"      raise \"malformed public key (invalid key size: #{pub.size})\"","class":"lineCov","hits":"1","order":"116",},
...
{"lineNum":"  506","line":"  def self.address_from_public_point(p : Secp256k1::ECPoint, version = \"00\", compressed = true)","class":"lineCov","hits":"1","order":"82",},
{"lineNum":"  507","line":"    # Takes the corresponding uncompressed public key."},
{"lineNum":"  508","line":"    pub = Secp256k1::Util.public_key_uncompressed_prefix p","class":"lineCov","hits":"1","order":"83",},
{"lineNum":"  509","line":""},
{"lineNum":"  510","line":"    # Generates a compressed address if specified."},
{"lineNum":"  511","line":"    pub = Secp256k1::Util.public_key_compressed_prefix p if compressed","class":"lineCov","hits":"1","order":"84",},
{"lineNum":"  512","line":"    address_from_public_key pub, version","class":"lineCov","hits":"1","order":"85",},
...
{"lineNum":"  526","line":"  def self.address_from_wif(wif : String)","class":"lineCov","hits":"1","order":"211",},
{"lineNum":"  527","line":"    # Only proceeds with valid WIF provided."},
{"lineNum":"  528","line":"    if wif_is_valid? wif","class":"lineCov","hits":"1","order":"212",},
{"lineNum":"  529","line":"      # Gets the version byte from the WIF."},
{"lineNum":"  530","line":"      vers = version_byte_from_wif wif","class":"lineCov","hits":"1","order":"213",},
{"lineNum":"  531","line":"      vers = vers.to_i 16","class":"lineCov","hits":"1","order":"219",},
{"lineNum":"  532","line":""},
{"lineNum":"  533","line":"      # The version byte of the public address is offset by `-128` (`-0x80`)."},
{"lineNum":"  534","line":"      vers -= 128","class":"lineNoCov","hits":"0",},
{"lineNum":"  535","line":""},
{"lineNum":"  536","line":"      # Makes sure the version byte is properly padded."},
{"lineNum":"  537","line":"      vers = Secp256k1::Util.to_padded_hex_01 vers","class":"lineCov","hits":"1","order":"220",},
{"lineNum":"  538","line":""},
{"lineNum":"  539","line":"      # Gets the private key from the WIF."},
{"lineNum":"  540","line":"      priv = private_key_from_wif wif","class":"lineCov","hits":"1","order":"221",},
{"lineNum":"  541","line":"      priv = BigInt.new priv, 16","class":"lineCov","hits":"1","order":"222",},
{"lineNum":"  542","line":""},
{"lineNum":"  543","line":"      # Checks wether we want a compressed or an uncompressed address."},
{"lineNum":"  544","line":"      comp = is_wif_compressed? wif","class":"lineCov","hits":"1","order":"223",},
{"lineNum":"  545","line":""},
{"lineNum":"  546","line":"      address_from_private priv, vers, comp","class":"lineCov","hits":"1","order":"229",},
{"lineNum":"  547","line":"    else"},
{"lineNum":"  548","line":"      raise \"invalid wallet import format (invalid wif: #{wif})\"","class":"lineCov","hits":"1","order":"230",},
...
{"lineNum":"  562","line":"  # ```"},
{"lineNum":"  563","line":"  def self.address_from_private(priv : BigInt, version = \"00\", compressed = true)","class":"lineCov","hits":"1","order":"79",},
{"lineNum":"  564","line":"    # Having a private ECDSA key; take the corresponding public key generated with it."},
{"lineNum":"  565","line":"    p = Secp256k1::Util.public_key_from_private priv","class":"lineCov","hits":"1","order":"80",},
{"lineNum":"  566","line":"    address_from_public_point p, version, compressed","class":"lineCov","hits":"1","order":"81",},
{"lineNum":"  567","line":"  end"},
{"lineNum":"  568","line":"end"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "run_coverage", "date" : "2021-09-29 14:06:26", "instrumented" : 117, "covered" : 113,};
var merged_data = [];
