...
{"lineNum":"   56","line":"    # ```"},
{"lineNum":"   57","line":"    def initialize(@key_pair)","class":"lineCov","hits":"1","order":"232",},
{"lineNum":"   58","line":"      @address = Ethereum.address_from_private @key_pair.private_key","class":"lineCov","hits":"1","order":"233",},
{"lineNum":"   59","line":"    end"},
{"lineNum":"   60","line":""},
...
{"lineNum":"  146","line":"    # ```"},
{"lineNum":"  147","line":"    def initialize(@key_pair, host, port)","class":"lineCov","hits":"1","order":"265",},
{"lineNum":"  148","line":"      @address = Socket::IPAddress.new(host, port)","class":"lineCov","hits":"1","order":"266",},
...
{"lineNum":"  191","line":"    # ```"},
{"lineNum":"  192","line":"    def to_s","class":"lineCov","hits":"1","order":"267",},
{"lineNum":"  193","line":"      \"enode://#{@key_pair.to_s}@#{@address.to_s}\"","class":"lineCov","hits":"1","order":"268",},
...
{"lineNum":"  210","line":"  def self.address_checksum(adr : String)","class":"lineCov","hits":"1","order":"248",},
{"lineNum":"  211","line":"    # Makes sure the address is lower case."},
{"lineNum":"  212","line":"    adr = adr.downcase","class":"lineCov","hits":"1","order":"249",},
{"lineNum":"  213","line":""},
{"lineNum":"  214","line":"    if adr.size === 42","class":"lineCov","hits":"1","order":"250",},
{"lineNum":"  215","line":"      # Trims a leading `\"0x\"`."},
{"lineNum":"  216","line":"      adr = adr[2, 40]","class":"lineCov","hits":"1","order":"271",},
{"lineNum":"  217","line":"    end"},
{"lineNum":"  218","line":""},
{"lineNum":"  219","line":"    if adr.size === 40","class":"lineCov","hits":"1","order":"251",},
{"lineNum":"  220","line":"      # Gets a Keccak-256 hash to operate on according to EIP-55."},
{"lineNum":"  221","line":"      keccak = Hash.keccak256 adr","class":"lineCov","hits":"1","order":"252",},
{"lineNum":"  222","line":""},
{"lineNum":"  223","line":"      # Prefixes the address with `\"0x\"`."},
{"lineNum":"  224","line":"      address = \"0x\"","class":"lineCov","hits":"1","order":"256",},
{"lineNum":"  225","line":""},
{"lineNum":"  226","line":"      # Iterates each character to determine capitalization."},
{"lineNum":"  227","line":"      i = 0","class":"lineCov","hits":"1","order":"257",},
{"lineNum":"  228","line":"      while i < adr.size","class":"lineCov","hits":"1","order":"258",},
{"lineNum":"  229","line":"        k = keccak[i].to_i 16","class":"lineCov","hits":"1","order":"259",},
{"lineNum":"  230","line":"        if k >= 8","class":"lineCov","hits":"1","order":"260",},
{"lineNum":"  231","line":"          address += \"#{adr[i]}\".upcase","class":"lineCov","hits":"1","order":"262",},
{"lineNum":"  232","line":"        else"},
{"lineNum":"  233","line":"          address += \"#{adr[i]}\".downcase","class":"lineCov","hits":"1","order":"261",},
{"lineNum":"  234","line":"        end"},
{"lineNum":"  235","line":"        i += 1","class":"lineCov","hits":"1","order":"263",},
{"lineNum":"  236","line":"      end"},
{"lineNum":"  237","line":"      address"},
{"lineNum":"  238","line":"    else"},
{"lineNum":"  239","line":"      raise \"malformed ethereum address (invalid size: #{adr.size})\"","class":"lineCov","hits":"1","order":"264",},
...
{"lineNum":"  256","line":"  def self.address_from_public_key(pub : String)","class":"lineCov","hits":"1","order":"240",},
{"lineNum":"  257","line":"    if pub.size === 130","class":"lineCov","hits":"1","order":"241",},
{"lineNum":"  258","line":"      # Trims a leading prefix."},
{"lineNum":"  259","line":"      pub = pub[2, 128]","class":"lineNoCov","hits":"0",},
{"lineNum":"  260","line":"    end"},
{"lineNum":"  261","line":""},
{"lineNum":"  262","line":"    # Ensures to use uncompressed public keys."},
{"lineNum":"  263","line":"    if pub.size === 128","class":"lineCov","hits":"1","order":"242",},
{"lineNum":"  264","line":"      # Hashes the uncompressed public key with Keccak-256."},
{"lineNum":"  265","line":"      keccak = Hash.keccak256 Hash.hex_to_bin pub","class":"lineCov","hits":"1","order":"243",},
{"lineNum":"  266","line":""},
{"lineNum":"  267","line":"      # Takes the last 20 bytes from the hash"},
{"lineNum":"  268","line":"      address_checksum keccak[24, 40]","class":"lineCov","hits":"1","order":"247",},
{"lineNum":"  269","line":"    else"},
{"lineNum":"  270","line":"      raise \"malformed public key (invalid key size: #{pub.size})\"","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  280","line":"  def self.address_from_public_point(p : Secp256k1::ECPoint)","class":"lineCov","hits":"1","order":"237",},
{"lineNum":"  281","line":"    # Takes the corresponding public key generated with it."},
{"lineNum":"  282","line":"    pub = Secp256k1::Util.public_key_uncompressed p","class":"lineCov","hits":"1","order":"238",},
{"lineNum":"  283","line":"    address_from_public_key pub","class":"lineCov","hits":"1","order":"239",},
...
{"lineNum":"  297","line":"  def self.address_from_private(priv : BigInt)","class":"lineCov","hits":"1","order":"234",},
{"lineNum":"  298","line":"    # Takes the corresponding public key generated with it."},
{"lineNum":"  299","line":"    p = Secp256k1::Util.public_key_from_private priv","class":"lineCov","hits":"1","order":"235",},
{"lineNum":"  300","line":"    address_from_public_point p","class":"lineCov","hits":"1","order":"236",},
{"lineNum":"  301","line":"  end"},
{"lineNum":"  302","line":"end"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "run_coverage", "date" : "2021-09-29 14:06:26", "instrumented" : 34, "covered" : 32,};
var merged_data = [];
