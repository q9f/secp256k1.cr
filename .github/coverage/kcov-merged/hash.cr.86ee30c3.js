...
{"lineNum":"   37","line":"  # ```"},
{"lineNum":"   38","line":"  def self.sha3(b : Bytes)","class":"lineCov","hits":"1","order":"275",},
{"lineNum":"   39","line":"    sha3 = Digest::SHA3.new(256)","class":"lineCov","hits":"1","order":"276",},
{"lineNum":"   40","line":"    sha3.update(b).hexdigest","class":"lineCov","hits":"1","order":"277",},
{"lineNum":"   41","line":"  end"},
{"lineNum":"   42","line":""},
...
{"lineNum":"   51","line":"  # ```"},
{"lineNum":"   52","line":"  def self.sha3(h : String)","class":"lineCov","hits":"1","order":"272",},
{"lineNum":"   53","line":"    sha3 = Digest::SHA3.new(256)","class":"lineCov","hits":"1","order":"273",},
{"lineNum":"   54","line":"    sha3.update(h).hexdigest","class":"lineCov","hits":"1","order":"274",},
{"lineNum":"   55","line":"  end"},
{"lineNum":"   56","line":""},
...
{"lineNum":"   65","line":"  # ```"},
{"lineNum":"   66","line":"  def self.keccak256(b : Bytes)","class":"lineCov","hits":"1","order":"244",},
{"lineNum":"   67","line":"    keccak = Digest::Keccak3.new(256)","class":"lineCov","hits":"1","order":"245",},
{"lineNum":"   68","line":"    keccak.update(b).hexdigest","class":"lineCov","hits":"1","order":"246",},
{"lineNum":"   69","line":"  end"},
{"lineNum":"   70","line":""},
...
{"lineNum":"   79","line":"  # ```"},
{"lineNum":"   80","line":"  def self.keccak256(h : String)","class":"lineCov","hits":"1","order":"253",},
{"lineNum":"   81","line":"    keccak = Digest::Keccak3.new(256)","class":"lineCov","hits":"1","order":"254",},
{"lineNum":"   82","line":"    keccak.update(h).hexdigest","class":"lineCov","hits":"1","order":"255",},
{"lineNum":"   83","line":"  end"},
{"lineNum":"   84","line":""},
...
{"lineNum":"   93","line":"  # ```"},
{"lineNum":"   94","line":"  def self.sha256(b : Bytes)","class":"lineCov","hits":"1","order":"91",},
{"lineNum":"   95","line":"    OpenSSL::Digest.new(\"SHA256\").update(b).final.hexstring","class":"lineCov","hits":"1","order":"92",},
{"lineNum":"   96","line":"  end"},
{"lineNum":"   97","line":""},
...
{"lineNum":"  106","line":"  # ```"},
{"lineNum":"  107","line":"  def self.sha256(h : String)","class":"lineCov","hits":"1","order":"160",},
{"lineNum":"  108","line":"    OpenSSL::Digest.new(\"SHA256\").update(h).final.hexstring","class":"lineCov","hits":"1","order":"161",},
...
{"lineNum":"  119","line":"  # ```"},
{"lineNum":"  120","line":"  def self.ripemd160(b : Bytes)","class":"lineCov","hits":"1","order":"94",},
{"lineNum":"  121","line":"    OpenSSL::Digest.new(\"RIPEMD160\").update(b).final.hexstring","class":"lineCov","hits":"1","order":"95",},
...
{"lineNum":"  132","line":"  # ```"},
{"lineNum":"  133","line":"  def self.ripemd160(h : String)","class":"lineCov","hits":"1","order":"278",},
{"lineNum":"  134","line":"    OpenSSL::Digest.new(\"RIPEMD160\").update(h).final.hexstring","class":"lineCov","hits":"1","order":"279",},
...
{"lineNum":"  145","line":"  # ```"},
{"lineNum":"  146","line":"  def self.base58_decode(s : String)","class":"lineCov","hits":"1","order":"179",},
{"lineNum":"  147","line":"    # Cycle through each character of string."},
{"lineNum":"  148","line":"    index = 0","class":"lineCov","hits":"1","order":"180",},
{"lineNum":"  149","line":"    decimal = BigInt.new 0","class":"lineCov","hits":"1","order":"181",},
{"lineNum":"  150","line":"    while index < s.size","class":"lineCov","hits":"1","order":"182",},
{"lineNum":"  151","line":"      b58_char = s[index]","class":"lineCov","hits":"1","order":"183",},
{"lineNum":"  152","line":"      position = BASE_58.index(b58_char)","class":"lineCov","hits":"1","order":"184",},
{"lineNum":"  153","line":"      if !position.nil?","class":"lineCov","hits":"1","order":"185",},
{"lineNum":"  154","line":"        decimal = decimal * 58 + position","class":"lineCov","hits":"1","order":"186",},
{"lineNum":"  155","line":"        index += 1","class":"lineCov","hits":"1","order":"280",},
{"lineNum":"  156","line":"      else"},
{"lineNum":"  157","line":"        raise \"cannot decode, invalid base58 character: \'#{s[index]}\'\"","class":"lineCov","hits":"1","order":"187",},
{"lineNum":"  158","line":"      end"},
{"lineNum":"  159","line":"    end"},
{"lineNum":"  160","line":""},
{"lineNum":"  161","line":"    # Count leading `1`s and pad with `\"00\"` bytes."},
{"lineNum":"  162","line":"    hex = decimal.to_s 16","class":"lineCov","hits":"1","order":"188",},
{"lineNum":"  163","line":"    leading = 0","class":"lineCov","hits":"1","order":"189",},
{"lineNum":"  164","line":"    while s[leading] === \'1\'","class":"lineCov","hits":"1","order":"190",},
{"lineNum":"  165","line":"      leading += 1","class":"lineNoCov","hits":"0",},
{"lineNum":"  166","line":"      hex = \"00#{hex}\"","class":"lineCov","hits":"1","order":"191",},
...
{"lineNum":"  179","line":"  # ```"},
{"lineNum":"  180","line":"  def self.base58_encode(h : String)","class":"lineCov","hits":"1","order":"101",},
{"lineNum":"  181","line":"    # Do a Base-58 mapping for the hash."},
{"lineNum":"  182","line":"    pub = BigInt.new h, 16","class":"lineCov","hits":"1","order":"102",},
{"lineNum":"  183","line":"    adr = String.new","class":"lineCov","hits":"1","order":"103",},
{"lineNum":"  184","line":"    while pub > 0","class":"lineCov","hits":"1","order":"104",},
{"lineNum":"  185","line":"      pub, rem = pub.divmod 58","class":"lineCov","hits":"1","order":"105",},
{"lineNum":"  186","line":"      adr += base58_char rem.to_i","class":"lineCov","hits":"1","order":"106",},
{"lineNum":"  187","line":"    end"},
{"lineNum":"  188","line":""},
{"lineNum":"  189","line":"    # Replace leading zero bytes with `1`."},
{"lineNum":"  190","line":"    i, s = 0, 2","class":"lineCov","hits":"1","order":"110",},
{"lineNum":"  191","line":"    current_byte = h[i, s]","class":"lineCov","hits":"1","order":"111",},
{"lineNum":"  192","line":"    while current_byte.to_i(16) === 0","class":"lineCov","hits":"1","order":"112",},
{"lineNum":"  193","line":"      adr = \"#{adr}1\"","class":"lineCov","hits":"1","order":"113",},
{"lineNum":"  194","line":"      i += s","class":"lineNoCov","hits":"0",},
{"lineNum":"  195","line":"      current_byte = h[i, s]","class":"lineCov","hits":"1","order":"114",},
{"lineNum":"  196","line":"    end"},
{"lineNum":"  197","line":""},
{"lineNum":"  198","line":"    # Reverse because we did the entire conversion backwards."},
{"lineNum":"  199","line":"    adr.reverse","class":"lineCov","hits":"1","order":"115",},
...
{"lineNum":"  209","line":"  # # => \'F\'"},
{"lineNum":"  210","line":"  # ```"},
{"lineNum":"  211","line":"  def self.base56_char(i : Int32)","class":"lineCov","hits":"1","order":"152",},
{"lineNum":"  212","line":"    i = i % 56","class":"lineCov","hits":"1","order":"153",},
{"lineNum":"  213","line":"    BASE_56[i]","class":"lineCov","hits":"1","order":"154",},
...
{"lineNum":"  223","line":"  # # => \'E\'"},
{"lineNum":"  224","line":"  # ```"},
{"lineNum":"  225","line":"  def self.base58_char(i : Int32)","class":"lineCov","hits":"1","order":"107",},
{"lineNum":"  226","line":"    i = i % 58","class":"lineCov","hits":"1","order":"108",},
{"lineNum":"  227","line":"    BASE_58[i]","class":"lineCov","hits":"1","order":"109",},
...
{"lineNum":"  251","line":"  # ```"},
{"lineNum":"  252","line":"  def self.hex_to_bin(h : String)","class":"lineCov","hits":"1","order":"89",},
{"lineNum":"  253","line":"    h.hexbytes","class":"lineCov","hits":"1","order":"90",},
{"lineNum":"  254","line":"  end"},
{"lineNum":"  255","line":"end"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "run_coverage", "date" : "2021-09-29 14:06:26", "instrumented" : 56, "covered" : 54,};
var merged_data = [];
