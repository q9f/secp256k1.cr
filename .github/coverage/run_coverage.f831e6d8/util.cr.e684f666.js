...
{"lineNum":"   23","line":"      return Num.new keccak.update(data.to_bytes).hexdigest","class":"lineCov","hits":"1","order":"227","possible_hits":"1",},
{"lineNum":"   24","line":"    end"},
{"lineNum":"   25","line":"  end"},
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"  def sha3(data : Num | String, entropy = 256)","class":"lineCov","hits":"6","order":"228","possible_hits":"6",},
{"lineNum":"   28","line":"    sha3 = Digest::SHA3.new entropy","class":"lineCov","hits":"2","order":"229","possible_hits":"2",},
{"lineNum":"   29","line":"    if data.is_a? String"},
{"lineNum":"   30","line":"      return Num.new sha3.update(data).hexdigest","class":"lineCov","hits":"1","order":"230","possible_hits":"1",},
{"lineNum":"   31","line":"    else"},
{"lineNum":"   32","line":"      return Num.new sha3.update(data.to_bytes).hexdigest","class":"lineCov","hits":"1","order":"231","possible_hits":"1",},
{"lineNum":"   33","line":"    end"},
{"lineNum":"   34","line":"  end"},
{"lineNum":"   35","line":""},
...
{"lineNum":"   41","line":"      return Num.new sha2.update(data.to_bytes).final.hexstring","class":"lineCov","hits":"1","order":"232","possible_hits":"1",},
{"lineNum":"   42","line":"    end"},
{"lineNum":"   43","line":"  end"},
{"lineNum":"   44","line":""},
{"lineNum":"   45","line":"  def ripemd160(data : Num | String)","class":"lineCov","hits":"2","order":"233","possible_hits":"2",},
{"lineNum":"   46","line":"    ripemd = OpenSSL::Digest.new \"RIPEMD160\"","class":"lineCov","hits":"2","order":"234","possible_hits":"2",},
{"lineNum":"   47","line":"    if data.is_a? String"},
{"lineNum":"   48","line":"      return Num.new ripemd.update(data).final.hexstring","class":"lineCov","hits":"1","order":"236","possible_hits":"1",},
{"lineNum":"   49","line":"    else"},
{"lineNum":"   50","line":"      return Num.new ripemd.update(data.to_bytes).final.hexstring","class":"lineCov","hits":"1","order":"235","possible_hits":"1",},
{"lineNum":"   51","line":"    end"},
{"lineNum":"   52","line":"  end"},
{"lineNum":"   53","line":"end"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "run_coverage", "date" : "2022-04-05 12:59:49", "instrumented" : 16, "covered" : 16,};
var merged_data = [];
