...
{"lineNum":"   34","line":"  # ```"},
{"lineNum":"   35","line":"  def keccak(data : Num | String, entropy = 256) : Num","class":"lineCov","hits":"6","order":"162","possible_hits":"6",},
...
{"lineNum":"   40","line":"      return Num.new keccak.update(data.to_bytes).hexdigest","class":"lineCov","hits":"1","order":"222","possible_hits":"1",},
{"lineNum":"   41","line":"    end"},
{"lineNum":"   42","line":"  end"},
{"lineNum":"   43","line":""},
...
{"lineNum":"   58","line":"  # ```"},
{"lineNum":"   59","line":"  def sha3(data : Num | String, entropy = 256) : Num","class":"lineCov","hits":"6","order":"223","possible_hits":"6",},
{"lineNum":"   60","line":"    sha3 = Digest::SHA3.new entropy","class":"lineCov","hits":"2","order":"224","possible_hits":"2",},
{"lineNum":"   61","line":"    if data.is_a? String"},
{"lineNum":"   62","line":"      return Num.new sha3.update(data).hexdigest","class":"lineCov","hits":"1","order":"225","possible_hits":"1",},
{"lineNum":"   63","line":"    else"},
{"lineNum":"   64","line":"      return Num.new sha3.update(data.to_bytes).hexdigest","class":"lineCov","hits":"1","order":"226","possible_hits":"1",},
{"lineNum":"   65","line":"    end"},
{"lineNum":"   66","line":"  end"},
{"lineNum":"   67","line":""},
...
{"lineNum":"   81","line":"  # ```"},
{"lineNum":"   82","line":"  def sha256(data : Num | String) : Num","class":"lineCov","hits":"2","order":"99","possible_hits":"2",},
...
{"lineNum":"   87","line":"      return Num.new sha2.update(data.to_bytes).final.hexstring","class":"lineCov","hits":"1","order":"227","possible_hits":"1",},
{"lineNum":"   88","line":"    end"},
{"lineNum":"   89","line":"  end"},
{"lineNum":"   90","line":""},
...
{"lineNum":"  104","line":"  # ```"},
{"lineNum":"  105","line":"  def ripemd160(data : Num | String) : Num","class":"lineCov","hits":"2","order":"228","possible_hits":"2",},
{"lineNum":"  106","line":"    ripemd = OpenSSL::Digest.new \"RIPEMD160\"","class":"lineCov","hits":"2","order":"229","possible_hits":"2",},
{"lineNum":"  107","line":"    if data.is_a? String"},
{"lineNum":"  108","line":"      return Num.new ripemd.update(data).final.hexstring","class":"lineCov","hits":"1","order":"231","possible_hits":"1",},
{"lineNum":"  109","line":"    else"},
{"lineNum":"  110","line":"      return Num.new ripemd.update(data.to_bytes).final.hexstring","class":"lineCov","hits":"1","order":"230","possible_hits":"1",},
...
{"lineNum":"  134","line":"  # ```"},
{"lineNum":"  135","line":"  def deterministic_k(priv : Num, hash : Num, order = N) : Num","class":"lineCov","hits":"4","order":"104","possible_hits":"4",},
{"lineNum":"  136","line":"    order_size = order.hex.size // 2","class":"lineCov","hits":"1","order":"105","possible_hits":"1",},
{"lineNum":"  137","line":"    v = Num.new Bytes.new order_size, 0x01","class":"lineCov","hits":"1","order":"106","possible_hits":"1",},
{"lineNum":"  138","line":"    k = Num.new Bytes.new order_size, 0x00","class":"lineCov","hits":"1","order":"111","possible_hits":"1",},
{"lineNum":"  139","line":"    concat = Util.concat_bytes v.bin, Bytes[0x00]","class":"lineCov","hits":"2","order":"112","possible_hits":"2",},
{"lineNum":"  140","line":"    concat = Util.concat_bytes concat, priv.bin","class":"lineCov","hits":"3","order":"118","possible_hits":"3",},
{"lineNum":"  141","line":"    concat = Util.concat_bytes concat, hash.bin","class":"lineCov","hits":"3","order":"119","possible_hits":"3",},
{"lineNum":"  142","line":"    k = OpenSSL::HMAC.digest(:sha256, k.bin, concat)","class":"lineCov","hits":"3","order":"120","possible_hits":"3",},
{"lineNum":"  143","line":"    v = OpenSSL::HMAC.digest(:sha256, k, v.bin)","class":"lineCov","hits":"2","order":"121","possible_hits":"2",},
{"lineNum":"  144","line":"    concat = Util.concat_bytes v, Bytes[0x00]","class":"lineCov","hits":"2","order":"122","possible_hits":"2",},
{"lineNum":"  145","line":"    concat = Util.concat_bytes concat, priv.bin","class":"lineCov","hits":"3","order":"123","possible_hits":"3",},
{"lineNum":"  146","line":"    concat = Util.concat_bytes concat, hash.bin","class":"lineCov","hits":"3","order":"124","possible_hits":"3",},
{"lineNum":"  147","line":"    k = OpenSSL::HMAC.digest(:sha256, k, concat)","class":"lineCov","hits":"3","order":"125","possible_hits":"3",},
{"lineNum":"  148","line":"    v = OpenSSL::HMAC.digest(:sha256, k, v)","class":"lineCov","hits":"2","order":"126","possible_hits":"2",},
{"lineNum":"  149","line":"    while true"},
{"lineNum":"  150","line":"      t = IO::Memory.new.to_slice","class":"lineCov","hits":"1","order":"127","possible_hits":"1",},
{"lineNum":"  151","line":"      while t.size < order_size","class":"lineCov","hits":"2","order":"128","possible_hits":"2",},
{"lineNum":"  152","line":"        v = OpenSSL::HMAC.digest(:sha256, k, v)","class":"lineCov","hits":"3","order":"129","possible_hits":"3",},
{"lineNum":"  153","line":"        t = Util.concat_bytes t, v","class":"lineCov","hits":"2","order":"130","possible_hits":"2",},
{"lineNum":"  154","line":"      end"},
{"lineNum":"  155","line":"      secret = Num.new t","class":"lineCov","hits":"1","order":"131","possible_hits":"1",},
{"lineNum":"  156","line":"      if secret.dec < order.dec && secret.dec > 0","class":"lineCov","hits":"2","order":"132","possible_hits":"2",},
...
{"lineNum":"  176","line":"  # ```"},
{"lineNum":"  177","line":"  def concat_bytes(x : Bytes, y : Bytes) : Bytes","class":"lineCov","hits":"2","order":"113","possible_hits":"2",},
{"lineNum":"  178","line":"    z = IO::Memory.new x.bytesize + y.bytesize","class":"lineCov","hits":"1","order":"114","possible_hits":"1",},
{"lineNum":"  179","line":"    x.each do |b|"},
{"lineNum":"  180","line":"      z.write_bytes UInt8.new b","class":"lineCov","hits":"1","order":"115","possible_hits":"1",},
{"lineNum":"  181","line":"    end"},
{"lineNum":"  182","line":"    y.each do |b|"},
{"lineNum":"  183","line":"      z.write_bytes UInt8.new b","class":"lineCov","hits":"1","order":"116","possible_hits":"1",},
{"lineNum":"  184","line":"    end"},
{"lineNum":"  185","line":"    return z.to_slice","class":"lineCov","hits":"1","order":"117","possible_hits":"1",},
{"lineNum":"  186","line":"  end"},
{"lineNum":"  187","line":"end"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "run_coverage", "date" : "2022-04-06 12:16:54", "instrumented" : 44, "covered" : 41,};
var merged_data = [];
