...
{"lineNum":"   49","line":"  # ```"},
{"lineNum":"   50","line":"  def sign(key : Key, hash : Num) : Signature","class":"lineCov","hits":"2","order":"102","possible_hits":"2",},
{"lineNum":"   51","line":"    k = Util.deterministic_k key.private_key, hash","class":"lineCov","hits":"1","order":"103","possible_hits":"1",},
{"lineNum":"   52","line":"    hash = hash.to_big","class":"lineCov","hits":"1","order":"133","possible_hits":"1",},
{"lineNum":"   53","line":"    priv = key.private_key.to_big","class":"lineCov","hits":"1","order":"134","possible_hits":"1",},
{"lineNum":"   54","line":"    point = Curve.mul G, k","class":"lineCov","hits":"1","order":"135","possible_hits":"1",},
{"lineNum":"   55","line":"    r = point.x.to_big % N.to_big","class":"lineCov","hits":"1","order":"137","possible_hits":"1",},
{"lineNum":"   56","line":"    k_inv = Curve.mod_inv k, N","class":"lineCov","hits":"1","order":"138","possible_hits":"1",},
{"lineNum":"   57","line":"    s = ((hash + r * priv) * k_inv.to_big) % N.to_big","class":"lineCov","hits":"1","order":"139","possible_hits":"1",},
{"lineNum":"   58","line":"    x_mag = point.x.to_big > N.to_big","class":"lineCov","hits":"1","order":"140","possible_hits":"1",},
{"lineNum":"   59","line":"    y_parity = (point.y.to_big % 2) == 0","class":"lineCov","hits":"1","order":"141","possible_hits":"1",},
{"lineNum":"   60","line":"    rec_id : Int8 = -1","class":"lineCov","hits":"1","order":"142","possible_hits":"1",},
{"lineNum":"   61","line":"    if !y_parity && x_mag","class":"lineCov","hits":"2","order":"143","possible_hits":"2",},
{"lineNum":"   62","line":"      rec_id = 3","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   63","line":"    elsif y_parity && x_mag","class":"lineCov","hits":"2","order":"144","possible_hits":"2",},
{"lineNum":"   64","line":"      rec_id = 2","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   65","line":"    elsif !y_parity && !x_mag","class":"lineCov","hits":"2","order":"145","possible_hits":"2",},
{"lineNum":"   66","line":"      rec_id = 1","class":"lineCov","hits":"1","order":"146","possible_hits":"1",},
{"lineNum":"   67","line":"    else"},
{"lineNum":"   68","line":"      rec_id = 0","class":"lineCov","hits":"4","order":"147","possible_hits":"4",},
{"lineNum":"   69","line":"    end"},
{"lineNum":"   70","line":"    r = Num.new r","class":"lineCov","hits":"1","order":"148","possible_hits":"1",},
{"lineNum":"   71","line":"    s = Num.new s","class":"lineCov","hits":"1","order":"149","possible_hits":"1",},
{"lineNum":"   72","line":"    v = Num.new BigInt.new rec_id","class":"lineCov","hits":"1","order":"150","possible_hits":"1",},
{"lineNum":"   73","line":"    Signature.new r, s, v","class":"lineCov","hits":"1","order":"151","possible_hits":"1",},
{"lineNum":"   74","line":"  end"},
{"lineNum":"   75","line":""},
...
{"lineNum":"   96","line":"  # ```"},
{"lineNum":"   97","line":"  def verify(sig : Signature, hash : Num, publ : Point) : Bool","class":"lineCov","hits":"2","order":"156","possible_hits":"2",},
{"lineNum":"   98","line":"    s_inv = Curve.mod_inv sig.s, N","class":"lineCov","hits":"1","order":"157","possible_hits":"1",},
{"lineNum":"   99","line":"    p0 = Curve.mul G, (hash.to_big * s_inv.to_big) % N.to_big","class":"lineCov","hits":"1","order":"158","possible_hits":"1",},
{"lineNum":"  100","line":"    p1 = Curve.mul publ, (sig.r.to_big * s_inv.to_big) % N.to_big","class":"lineCov","hits":"1","order":"159","possible_hits":"1",},
{"lineNum":"  101","line":"    p = Curve.add p0, p1","class":"lineCov","hits":"1","order":"160","possible_hits":"1",},
{"lineNum":"  102","line":"    sig.r.to_big === p.x.to_big","class":"lineCov","hits":"1","order":"161","possible_hits":"1",},
{"lineNum":"  103","line":"  end"},
{"lineNum":"  104","line":"end"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "run_coverage", "date" : "2022-04-06 11:52:18", "instrumented" : 28, "covered" : 26,};
var merged_data = [];
