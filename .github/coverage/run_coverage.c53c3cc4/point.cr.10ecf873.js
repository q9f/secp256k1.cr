...
{"lineNum":"   33","line":"  end"},
{"lineNum":"   34","line":""},
{"lineNum":"   35","line":"  def initialize(pub : String)","class":"lineCov","hits":"4","order":"204","possible_hits":"4",},
{"lineNum":"   36","line":"    case pub.size","class":"lineCov","hits":"1","order":"205","possible_hits":"1",},
{"lineNum":"   37","line":"    when 130, 128","class":"lineCov","hits":"2","order":"206","possible_hits":"2",},
{"lineNum":"   38","line":"      pub = pub[2, 128] if pub.size === 130","class":"lineCov","hits":"2","order":"207","possible_hits":"2",},
{"lineNum":"   39","line":"      @x = Num.new pub[0, 64]","class":"lineCov","hits":"1","order":"208","possible_hits":"1",},
{"lineNum":"   40","line":"      @y = Num.new pub[64, 64]","class":"lineCov","hits":"1","order":"209","possible_hits":"1",},
{"lineNum":"   41","line":"    when 66","class":"lineCov","hits":"2","order":"211","possible_hits":"2",},
{"lineNum":"   42","line":"      prefix = pub[0, 2]","class":"lineCov","hits":"1","order":"212","possible_hits":"1",},
{"lineNum":"   43","line":"      if prefix === \"02\" || prefix === \"03\"","class":"lineCov","hits":"2","order":"213","possible_hits":"2",},
{"lineNum":"   44","line":"        prime = P.to_big","class":"lineCov","hits":"1","order":"214","possible_hits":"1",},
{"lineNum":"   45","line":"        x = Num.new(pub[2, 64]).to_big","class":"lineCov","hits":"1","order":"215","possible_hits":"1",},
{"lineNum":"   46","line":""},
{"lineNum":"   47","line":"        a = x ** 3 % prime","class":"lineCov","hits":"1","order":"216","possible_hits":"1",},
{"lineNum":"   48","line":"        a = (a + 7) % prime","class":"lineCov","hits":"1","order":"217","possible_hits":"1",},
{"lineNum":"   49","line":"        e = ((prime + 1) // 4) % prime","class":"lineCov","hits":"1","order":"218","possible_hits":"1",},
{"lineNum":"   50","line":"        y = BigInt.new","class":"lineCov","hits":"1","order":"219","possible_hits":"1",},
{"lineNum":"   51","line":"        LibGMP.mpz_powm_sec(y, a, e, prime)","class":"lineCov","hits":"1","order":"220","possible_hits":"1",},
{"lineNum":"   52","line":""},
{"lineNum":"   53","line":"        y_parity = prefix.to_i - 2","class":"linePartCov","hits":"1","order":"221","possible_hits":"2",},
{"lineNum":"   54","line":"        y = -y % prime if y % 2 != y_parity","class":"lineCov","hits":"1","order":"222","possible_hits":"1",},
{"lineNum":"   55","line":""},
{"lineNum":"   56","line":"        @x = Num.new x","class":"lineCov","hits":"1","order":"223","possible_hits":"1",},
{"lineNum":"   57","line":"        @y = Num.new y","class":"lineCov","hits":"2","order":"224","possible_hits":"2",},
{"lineNum":"   58","line":"      else"},
{"lineNum":"   59","line":"        raise \"Invalid prefix for compressed public point: #{prefix}\"","class":"lineCov","hits":"2","order":"225","possible_hits":"2",},
{"lineNum":"   60","line":"      end"},
{"lineNum":"   61","line":"    else"},
{"lineNum":"   62","line":"      raise \"Unknown public point format (Invalid size: #{pub.size})\"","class":"lineCov","hits":"3","order":"210","possible_hits":"3",},
{"lineNum":"   63","line":"    end"},
{"lineNum":"   64","line":"  end"},
{"lineNum":"   65","line":""},
...
var header = { "command" : "run_coverage", "date" : "2022-04-05 14:23:53", "instrumented" : 36, "covered" : 36,};
var merged_data = [];
